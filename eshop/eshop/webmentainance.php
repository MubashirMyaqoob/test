...
<body class="row w-100" >
	...
	<!-- End Preloader -->
		...
		<hr class="bg-white">
  				...
  				<li class="list-item  py-2 bg-dark"><a href="WebMentainance.php" class="current text-center px-0">Web Mentainance</a></li>
			</ul>
		</div>
		<div class="col-md-9">
					...
					<table class="table shopping-summery">
						<thead>
							<tr class="main-hading">
								...
								<th class="text-center">Additional Text</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="product-des" data-title="Img ">
									<p class="product-des text-center"><?php echo $simple1['img'] ?></p>
								</td>
								<td class="product-des" data-title="Heading ">
									<p class="product-des text-center"><?php echo ucfirst($simple1['heading']) ?></p>
								</td>
								<td class="product-des" data-title="Description">
									<p class="product-des text-center"><?php echo ucfirst($simple1['text']) ?>.</p>
								</td>
								<td class="product-des" data-title="Additional Text">
									<p class="product-des text-center"><?php echo ucfirst($simple1['additionaltext']) ?></p>
								</td>
								<td class="product-des" data-title="Position">
									<p class="product-des text-center"><?php echo ucfirst($simple1['position']) ?></p>
								</td>
								<td class="product-des" data-title="Update">	
									<p class="product-des text-center"><button class="btn btn-dark"><a href="webupdate.php?id=<?php echo  $simple1['id'] ?>" class="text-light">Update</a></button></p>
								</td>

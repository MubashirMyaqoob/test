...
<body class="row w-100" >
	...
	<!-- End Preloader -->
		...
		<hr class="bg-white">
  				<li class="list-item  py-2 bg-dark"><a href="useraccount.php" class="current text-center px-0">Account Setting</a></li>
  				<li class="list-item  py-2 bg-dark"><a href="orderhistory.php" class="text-center px-0">Order History</a></li>
									...
									<div class="row">
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="pno" type="number" placeholder="" required value=<?php echo $simple['number']; ?>>
											</div>	
										</div>

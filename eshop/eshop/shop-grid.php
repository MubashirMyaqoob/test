									 ...
									 ?>
										...
										<ul class="dropdown">
											...
											$cn = $subsimple['subcategory'];
											 ?> 		
										<li>
											<a href="subfind.php?id=<?php echo $cn ?>"><?php echo $subsimple['subcategory']; ?></a>
										 </li><?php } ?>
										</ul>
									</li><?php } ?>	
					...
					<div class="col-lg-9 col-md-8 col-12 txtHint">
						...
						<div class="row">
							...
							if (isset($_GET['a'])) {
								...
								$q="SELECT * FROM `products` WHERE `category` LIKE '$s' or `sku` LIKE '$s' or `name` = '$s' or `price` LIKE '$s' or `subcategory` LIKE '$s'";

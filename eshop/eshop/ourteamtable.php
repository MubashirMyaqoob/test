...
<body class="row w-100" >
	...
	<!-- End Preloader -->
		...
		<hr class="bg-white">
  				...
  				<li class="list-item  py-2 bg-dark"><a href="ourteamtable.php" class="current text-center px-0">Team Member Table</a></li>
...
<div class="shopping-cart section">
	...
	echo "		<br><div class='alert alert-success'>
  										<a class='close' data-dismiss='alert' aria-label='close'>&times;</a>Team Member Details Has Been Updated.
										</div>";
		}
		 ?>
						...
						<tbody>
							...
							<tr>
								...
								<td class="product-des" data-title="Main Image">
									<p class="product-des text-center"><?php echo ucfirst($simple1['mainimg']);?></p>
								</td>
								<td class="product-des" data-title="Main Image">
									<p class="product-des text-center"><?php echo ucfirst($simple1['subimg']);?></p>
								</td>
								<td class="product-des" data-title="Update">	
									<p class="product-des text-center"><button class="btn btn-dark"><a href="ourteamupdate.php?id=<?php echo $simple1['id'] ?>" class="text-light">Update</a></button></p>
								</td>
								<form method="post">
								...
								<?php if (isset($_POST['go'])) {
									$hid = $_POST['id'];
									$q2 = "DELETE FROM `ourteam` WHERE `id` = '$hid' ";
									mysqli_query($db,$q2);
									header("location:ourteamtable.php");
								} ?>
							</form>
							</tr>
						<?php } ?>

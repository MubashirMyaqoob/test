...
<body class="row w-100" >
	...
	<!-- End Preloader -->
		...
		<hr class="bg-white">
  				...
  				<li class="list-item  py-2 bg-dark"><a href="Catogories.php" class="current text-center px-0">Categories</a></li>
							...
							<div class="form-main">
								...
								<form class="form" method="post" >
									...
									<div class="row">
										...
										<div class="col-lg-12 col-12">
											<div class="form-group">
												...
												<input name="sub" type="text" placeholder="" required>
											</div>
										</div>
										
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Main Catogory<span>*</span></label><br>
												<select name="main">
													<?php while ($simple2 = mysqli_fetch_assoc($run2)) {  ?>

													<option value=<?php echo ucfirst($simple2['id'])?>><?php echo ucfirst($simple2['Category']) ?></option>
													<?php } ?>
												</select>
									...
									<?php if (isset($_POST['submit'])) {
										...
										$q5= "SELECT * FROM `subcategory` WHERE `subcategory` = '$s' " ;
										$run5 = mysqli_query($db,$q5);
										$count = mysqli_num_rows($run5);
										if ($count == 1 ) {
										echo "<br><div class='alert alert-danger'>
  										<a class='close' data-dismiss='alert' aria-label='close'>&times;</a>This Sub Category has Already been added.
										</div>";
										}else{
										$q3 = "INSERT INTO `subcategory`( `subcategory`, `categoryid`) VALUES ('$s','$m')";
										$run3=mysqli_query($db,$q3);
										echo "<br><div class='alert alert-success'>
  										<a class='close' data-dismiss='alert' aria-label='close'>&times;</a>Sub Category has been added.
										</div>";
									}
									}
									 ?>
							...
							<div class="form-main">
								...
								<form class="form" method="post" >
									<div class="row">
										...
										<div class="col-lg-12 col-12">
											<div class="form-group">
												<label>Main Category Name<span>*</span></label>
												<input name="category" type="text" placeholder="" required>
											</div>
										</div>
										<div class="col-12">
											<div class="form-group button">
									...
									<?php if (isset($_POST["go"])) {
										$c = $_POST['category'];
										$q4 = "SELECT * FROM `category` WHERE `Category` = '$c'";
										$run4 = mysqli_query($db,$q4);
										$count = mysqli_num_rows($run4);
										if ($count == 1 ) {
										echo "<br><div class='alert alert-danger'>
  										<a class='close' data-dismiss='alert' aria-label='close'>&times;</a>This Category has Already been added.
										</div>";
										}else{
										$q1 = "INSERT INTO `category`(`Category`) VALUES ('$c')";
										$run1 = mysqli_query($db,$q1);
										echo "<br><div class='alert alert-success'>
  										<a class='close' data-dismiss='alert' aria-label='close'>&times;</a>Category has been added.
										</div>";
									}
									} ?>
								</form>

...
<body class="row w-100" >
	...
	<!-- End Preloader -->
		...
		<hr class="bg-white">
  				...
  				<li class="list-item  py-2 bg-dark"><a href="ordertable.php" class="current text-center px-0">Order Table</a></li>
					...
					<table class="table shopping-summery">
						<thead>
							<tr class="main-hading">
								...
								<th class="text-center">Client Message</th>
								<th class="text-center">Client Total</th> 
								
							</tr>
						</thead>
						<tbody>
							<?php 
							$q1= "SELECT * FROM `ordertabel`";
							...
							<tr>
								<td class="product-des" data-title="Product Name">
									<p class="product-des text-center"><?php echo ucfirst($simple1['productname']); ?></p>
								</td>
								<td class="product-des" data-title="Product Size">
									<p class="product-des text-center"><?php echo ucfirst($simple1['productsize']); ?></p>
								</td>
								<td class="product-des" data-title="Product Quantity">
									<p class="product-des text-center"><?php echo ucfirst($simple1['productquantity']); ?></p>
								</td>
								<td class="product-des" data-title="Client Name">
									<p class="product-des text-center"><?php echo ucfirst($simple1['name']); ?></p>
								</td>
								<td class="product-des" data-title="Client Email">
									<p class="product-des text-center"><?php echo ucfirst($simple1['email']); ?></p>
								</td>
								<td class="product-des" data-title="Client Cellnumber">
									<p class="product-des text-center"><?php echo ucfirst($simple1['cellnumber']); ?></p>
								</td>
								<td class="product-des" data-title="Client Address">
									<p class="product-des text-center"><?php echo ucfirst($simple1['address']); ?></p>
								</td>
								<td class="product-des" data-title="Client Message">
									<p class="product-des text-center"><?php echo ucfirst($simple1['message']); ?></p>
								</td>
								<td class="product-des" data-title="Client Total">
									<p class="product-des text-center"><?php echo ucfirst($simple1['total']); ?></p>
								</td>
							</tr>
						<?php } ?>
						</tbody>

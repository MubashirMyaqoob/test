...
<body class="row w-100" >
	...
	<!-- End Preloader -->
		...
		<hr class="bg-white">
  				...
  				<li class="list-item  py-2 bg-dark"><a href="ourteaminsert.php" class="current text-center px-0">Team Member Insert</a></li>
							...
							<div class="form-main">
								...
								<form class="form" method="post" enctype="multipart/form-data" >
									<div class="row">
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Team Member Position<span>*</span></label>
									...
									if (isset($_POST['go'])) {
										...
										move_uploaded_file($location1, $destination1);
										 $q1 = "INSERT INTO `ourteam`(`mainimg`, `subimg`, `name`, `position`) VALUES ('$destination','$destination1','$n','$p')";
										 $run1 = mysqli_query($db,$q1);
										echo "<br><div class='alert alert-success'>
  										<a class='close' data-dismiss='alert' aria-label='close'>&times;</a>New Member Has Been Inserted.
										</div>";
									}
